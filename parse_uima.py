...
def get_cases(engine):
    ...
    sql = """
        ...
        FROM med_mentions.medmentions_annotations;
    """
    
    cases = pd.read_sql(sql, con=engine)
    
    return set(cases['file'].tolist())
...
# sofa -> db
def write_sofa(u, view, corpus, engine):
    import pandas as pd
    ...
    if engine.dialect.has_table(engine, "sofas"):
        sql = text("SELECT * FROM med_mentions.sofas WHERE note_id = :e1")
    ...
    if parse_to_sql:
        ...
        for corpus in corpora:
            ...
            for system in systems:
                ...
                # location of custom TypeSystem config files
                dir_test = '/Users/gms/development/nlp/nlpie/scripts/python/ensembling/system_annotations/typesystems/' + system + '/'
                ...
                # parse directory of annotations
                directory_to_parse = '/Users/gms/development/nlp/nlpie/data/ensembling-u01/' + corpus + '/system_annotations/' +  system + '_out/' 
               
                print(directory_to_parse)
                
                # get cases to parse
                cases = get_cases(engine)
                ...
                #for fname in glob.glob(directory_to_parse + '/527982345.txt.xmi'):
                    ...
                    if u in cases:
                        ...
                        write_sofa(u, view, corpus, engine)

                        if not write_sofa_only:
                            for t in types:
                                print("TYPE:", t)
                                ...
                                if len(annotations) > 0:
                                    ...
                                    # write to database
                                    annotations.to_sql(table_name, engine, if_exists="append", index=False) 
